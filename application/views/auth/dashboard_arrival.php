         ...
         <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color: #4B0082;;">
             ...
             <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('dashboard'); ?>">
                 <div class="sidebar-brand-icon">
                     <img style="width: 40px; height: 40px;" class="img-profile " src="<?php echo base_url('assets/img/profile/surat.png'); ?>">
                 </div>
             ...
             <div class="row">
                 <div class="alert alert-secondary" role="alert">
                     <ul class="nav">
                         <li class="nav-item">
                             <a class="nav-link 
                        <?= ($this->uri->segment(2) == '') ? 'disabled' : 'text-primary' ?>" href="
                        <?= base_url('dashboard/') ?>">Departure</a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link 
                        <?= ($this->uri->segment(2) == 'arrival') ? 'disabled' : 'text-primary' ?>" href="
                        <?= base_url('dashboard/arrival/') ?>">Arrival</a>
                         </li>
                     </ul>
                 </div>
             </div>
 ...
 <!-- <script>
     ...
     function get_data() {
         $.ajax({
             url: "<?= base_url('dashboard/json_departure') ?>",
             type: "GET",
