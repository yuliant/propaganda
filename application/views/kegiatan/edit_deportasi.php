        ...
        <div class="row">
        	<div class="col-lg-10">
	        	<div class="card">
				  ...
				  <div class="card-body">
				    <?php echo form_open_multipart('kegiatan/edit_deportasi/'.$dep['id_deportasi']); ?>
				    <input type="text" name="id_deportasi" id="id_deportasi" value="<?php echo $dep['id_deportasi']?>" hidden />
                        <div class="form-group row">
                            <label for="nama" class="col-sm-3 col-form-label">Nama</label>
                        	  <div class="col-sm-8">
                              <input type="text" class="form-control" id="name" name="nama" value="<?php echo $dep['nama']?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              ...
                              <option value="<?php echo $dep['jk']?>"><?php echo $dep['jk']?></option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="alamat" name="alamat" value="<?php echo $dep['alamat']?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="date" class="form-control" id="tgl_l" name="tgl_l" value="<?php echo $dep['tgl_l']?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="paspor" name="paspor" value="<?php echo $dep['paspor']?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="date" class="form-control" id="masa" name="masa" value="<?php echo $dep['masa']?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="niora" name="niora" value="<?php echo $dep['niora']?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="kebangsaan" name="kebangsaan" value="<?php echo $dep['kebangsaan']?>">
                       	...
                       	<div class="form-group row">
                          	...
                          	<div class="col-sm-8">
                           		<input type="text" class="form-control" id="sponsor" name="sponsor" value="<?php echo $dep['sponsor']?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="jabatan" name="jabatan" value="<?php echo $dep['jabatan']?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="jenis_doc" name="jenis_doc" value="<?php echo $dep['jenis_doc']?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="pasal" name="pasal" value="<?php echo $dep['pasal']?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="pelanggaran" name="pelanggaran" value="<?php echo $dep['pelanggaran']?>" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="no_putusan" name="no_putusan" value="<?php echo $dep['no_putusan']?>" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="isi" name="isi" value="<?php echo $dep['isi']?>" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="date" class="form-control" id="tgl_putusan" name="tgl_putusan" value="<?php echo $dep['tgl_putusan']?>">
                        ...
                        <div class="form-group row">
						    ...
						    <div class="col-sm-8">
						    	<div class="row">
						    		<div class="col-sm-4">
						    			<img src="<?php echo base_url('assets/berkas/deportasi/'). $dep['foto_paspor'] ?>" class="img-thumbnail">
						    		</div>
	                     ...
	                     <label class="custom-file-label" for="foto_paspor" >Choose file</label>
			  			...
			  			<div class="form-group row">
						    ...
						    <div class="col-sm-8">
						    	<div class="row">
						    		<div class="col-sm-4">
						    			<img src="<?php echo base_url('assets/berkas/deportasi/'). $dep['foto_wna'] ?>" class="img-thumbnail">
						    		</div>
                        ...
                        <a href="<?php echo base_url('kegiatan/deportasi') ?>" class="btn btn-primary btn-sm float-right" >Kembali</a>
                    </form>
				  </div>
				</div>        		
        	</div>
