        ...
        <div class="row">
        	<div class="col-lg-10">
	        	<div class="card">
				  ...
				  <div class="card-body">
				    <?php echo form_open_multipart('kegiatan/edit_projus/'.$projus['id_projus']); ?>
				    <input type="text" name="id_projus" id="id_projus" value="<?php echo $projus['id_projus']?>" hidden />
                      ...
                      <div class="form-group row">
                        ...
                        <div class="form-group row">
						    ...
						    <div class="col-sm-8">
						    	<div class="row">
						    		<div class="col-sm-4">
						    			<img src="<?php echo base_url('assets/berkas/projustisia/'). $projus['foto_paspor'] ?>" class="img-thumbnail">
						    		</div>
                        ...
                        <a href="<?php echo base_url('kegiatan/projustisia') ?>" class="btn btn-primary btn-sm float-right" >Kembali</a>
                    </form>
				  </div>
				</div>        		
        	</div>
