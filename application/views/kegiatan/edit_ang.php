    ...
    <div class="container-fluid">
        ...
        <div class=" col-lg-5">
        	...
        	<div class="card shadow mb-4">
	            ...
	            <!-- Card Body -->
	            <form action="<?php echo base_url();?>kegiatan/edit_ang/<?php echo $id_ang; ?>" method="post">
	            	<div class="card-body mb-4">
		            	<div class="form-group row">
		             	...
		             	<div class="form-group row">
					      ...
					      <div class="row col-lg">
					        <input style="text-align: right;" type="text" class="form-control" id="jumlah" name="jumlah" value="<?php echo ($ang['jumlah'])?>">
						...
						<a href="<?php echo base_url('kegiatan/anggaran') ?>" class="btn btn-primary btn-sm mr-3" style="float: right;" >Kembali</a>
		            </div>
	            </form>
