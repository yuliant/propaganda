       ...
       <div class="row">
          <div class="col-lg-6">
              ...
              <div class="card">
                ...
                <div class="card-body">
                   <?php echo form_open_multipart('kegiatan/bap'); ?>
                ...
                <div class="card-body">
                  <table class="table table-hover" id="bap">
                          ...
                          <tbody>
                              ...
                              <?php foreach ($bap as $b) : ?>

                              <tr>
                                  <th scope="row"><?php echo $i; ?></th>
                                  <td><?php echo $b['nama']; ?></td>
                                  <td>
                                    <a href="<?php echo base_url(); ?>kegiatan/detail_bap/<?php echo$b['id_bap']; ?>" class="btn btn-primary btn-sm"><i class="fas fa-search-plus"></i></a>
                                    <a href="<?php echo base_url(); ?>kegiatan/edit_bap/<?php echo$b['id_bap']; ?>" class="btn btn-warning btn-sm"><i class="far fa-edit"></i></a>
                                    <a href="<?php echo base_url(); ?>kegiatan/delete_bap/<?php echo$b['id_bap']; ?>" class="btn btn-danger btn-sm"><i class="far fa-trash-alt"></i></a>
                                  </td>
